...
export type PostSnippetFragment = (
  { __typename?: 'Post' }
  & Pick<Post, 'id' | 'title' | 'createdAt' | 'updatedAt' | 'creatorId' | 'points' | 'voteStatus' | 'textSnippet'>
  & { creator: (
    { __typename?: 'User' }
...
export type CreatePostMutation = (
  ...
  & { createPost: (
    { __typename?: 'Post' }
    & Pick<Post, 'title' | 'createdAt' | 'id' | 'updatedAt' | 'creatorId' | 'points'>
  ) }
);
...
export type UpdatePostMutation = (
  ...
  & { updatePost?: Maybe<(
    { __typename?: 'Post' }
    & Pick<Post, 'title' | 'text' | 'id' | 'textSnippet'>
  )> }
);
...
export type PostQuery = (
  ...
  & { post?: Maybe<(
    { __typename?: 'Post' }
    & Pick<Post, 'id' | 'title' | 'createdAt' | 'updatedAt' | 'creatorId' | 'points' | 'voteStatus' | 'text'>
    & { creator: (
      { __typename?: 'User' }
      & Pick<User, 'username' | 'id'>
    ) }
